...
| 6 | Cartas da BAG e da mão são molduras genéricas com ícone | usar `ui/card_face_<el>_v1.png` (light/dark/wild = **v3**); BAG 78×108, mão 156×216 | spec/ASSETS.md |
...
- A mão tem **2 fileiras de 5 cartas** (10 slots), como no mock.
